...
Кроме `npm run check` сценарии прогонялись в headless Chrome по Chrome DevTools
Protocol против production-сборки. Полные списки проверок с замерами —
[browser-checks.md](browser-checks.md): переход на настоящую схему API,
причёсывание UI списка, сжатие панели фильтров, prefetch по intent и флаг моков.
